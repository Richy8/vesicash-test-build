...
export default {
  ...
  components: {
    ...
    ActivityCard: () =>
      import(
        /* webpackChunkName: "dashboard-module" */ "@/modules/dashboard/components/card-comps/activity-card"
      ),
    UsersTable: () =>
      import(
        /* webpackChunkName: "dashboard-module" */ "@/modules/dashboard/components/table-comps/users-table"
      ),
    DashboardTransactions: () =>
      import(

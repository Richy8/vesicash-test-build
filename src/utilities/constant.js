...
export const VESICASH_API_BASE_URL = `${process.env.VUE_APP_VESICASH_API_BASE_URL}/${process.env.VUE_APP_VESICASH_API_VERSION}`;

export const VESICASH_PRIVATE_KEY = process.env.VUE_APP_VESICASH_PRIVATE_KEY;

export const VESICASH_PUBLIC_KEY = process.env.VUE_APP_VESICASH_PUBLIC_KEY;
